...
const char* BIP71_MIMETYPE_PAYMENT = "application/digiwage-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/digiwage-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/digiwage-paymentrequest";
...
//
// OSX-specific way of handling digiwage: URIs and
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in digiwage: URIs
...
bool PaymentServer::processPaymentRequest(PaymentRequestPlus& request, SendCoinsRecipient& recipient)
{
    ...
    Q_FOREACH (const PAIRTYPE(CScript, CAmount) & sendingTo, sendingTos) {
        ...
        if (ExtractDestination(sendingTo.first, dest)) {
            ...
            // Insecure payments to custom digiwage addresses are not supported
