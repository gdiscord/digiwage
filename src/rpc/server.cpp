...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"digiwage", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"digiwage", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"digiwage", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"digiwage", "masternodecurrent", &masternodecurrent, true, true, false},
        {"digiwage", "masternodedebug", &masternodedebug, true, true, false},
        {"digiwage", "reloadmasternodeconfig", &reloadmasternodeconfig, true, true, false},
